...
% Configure Math Caligraphy bold command
\DeclareMathAlphabet{\mathbcal}{OMS}{cmsy}{b}{n}

% Configure EulerScript font to replace Script
\usepackage[mathscr]{euscript}
% Configure Math Script bold command
...
\SetTitle{SPATIAL LOW-RANK TENSOR FACTORIZATION FOR HYPERSPECTRAL IMAGE UNMIXING}
...
\SetNameb{Heidy Sierra}
\SetDegreeb{Ph.D}
% Third Member Graduate Commitee
\SetNamec{Wilson Rivera Gallego}
\SetDegreec{Ph.D}
% President Graduate Commitee (Normally Chairman)
\SetNamePres{Vidya Manian}			
\SetDegreePres{Ph.D}
% Graduate Studies Representative
\SetNameRep{Graduate Studies Representative}
\SetDegreeRep{ }
